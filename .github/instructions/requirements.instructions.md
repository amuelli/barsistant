...
## Purpose & Scope
Barsistant is a web app for storing, searching, and extracting cocktail recipes, with AI-powered extraction from URLs (websites, YouTube, blogs). It supports inventory tracking, favorites, and recipe discovery.
...
- Secure authentication (magic links)
  - Magic link authentication should open the app directly in the Barsistant PWA when possible, for a seamless user experience.
...
*This document is a living summary. For full details, see the referenced files and docs. Remove or update requirements here as features are completed or superseded.*
